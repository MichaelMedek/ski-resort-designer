"""Reload-safe comparison for str-Enum members.
...
string form (`'ClassName.MEMBER'`), which is identical across reloads and class-prefixed
so members of different enums never compare equal.
